...
if __name__ == '__main__':
    ...
    colnames_right = ["IPU", "Overlap", "ReactionTime", "FilledBreaks", "Feedbacks", "Discourses", "Particles", "Laughters", "JointLaugh", "Polarity", "Subjectivity"]
